...
internal sealed class DomainEventPublisher(IServiceProvider provider) : IDomainEventPublisher
{
    // cachés de reflexión para evitar recalcular tipos genéricos en cada llamada
